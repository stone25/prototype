...
if($connexion->connecter())
{
	$query = "SELECT id_art, titre_art, cont1_art, cont2_art, cit_art, aut_art, photo1_art, photo2_art, date_art, MONTHNAME(date_art) AS mois, vue_art, stat_art, nom_user, pren_user FROM article INNER JOIN blogueur ON blogueur.id_user = article.id_user WHERE stat_art = 'Visible' ORDER BY date_art DESC";
