                ...
                <div class="classy-menu">
                    ...
                    <div class="classynav">
                        <ul id="nav">
                            ...
                            <li <?php if(isset($menu_selected['presentation'])){echo $menu_selected['presentation'];} ?> ><a href="presentation.php">Présentation</a></li>
                            <li <?php if(isset($menu_selected['diocese'])){echo $menu_selected['diocese'];} ?> ><a href="diocese.php">Diocèses</a></li>
                            <li <?php if(isset($menu_selected['blog'])){echo $menu_selected['blog'];} ?> ><a href="blog.php">Blog</a></li>
                            <!--li <?php if(isset($menu_selected['activite'])){echo $menu_selected['activite'];} ?> ><a href="activite/index.php">Activités</a></li-->
