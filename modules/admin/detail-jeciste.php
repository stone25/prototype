...
if($connexion)
{
    $req = "select jeciste.id as id, matricule, nom, prenom, date, lieu, contact, email, sexe, photo, cni, sang, denomination, statut, diocese.libelle as diocese from jeciste inner join militer on jeciste.id = militer.idjeciste inner join instance on militer.idinstance = instance.id inner join diocese on diocese.id = instance.iddiocese where jeciste.id = '$_GET[id]'";
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="form-group">
                                                                <select name="responsabilite" class="form-control">
                                                                    <?php 
                                                                        $respo1 = $respo2 = $respo3 = $respo4 = $respo5 = $respo6 = $respo7 = $respo8 = $respo9 = $respo10 = $respo11 = $respo12 = $respo13 = $respo14 = '';
                                                                        ...
                                                                        else if($rows['statut'] == 'Membre')
                                                                        { 
                                                                            $respo13 = 'selected';
                                                                        }
                                                                        else if($rows['statut'] == 'Aîné(e)')
                                                                        { 
                                                                            $respo14 = 'selected';
                                                                        }
                                                                    ?>
                                                                    ...
                                                                    <option <?php echo $respo14 ?>>Aîné(e)</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
