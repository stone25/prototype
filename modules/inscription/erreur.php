	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-85 p-b-20">
				...
				<h5 style="text-align: center"><span style="color: red; ">Vous êtes déjà inscrit(e)</span> </h5>  
				<h6 style="text-align: center">En cas de perte de votre matricule, pas la peine de vous réinscire: Contactez le Bureau National</h6>
				...
				<form class="login100-form validate-form" style="margin-top: 30px;" action='../src/control/inscription/inscription.php' method='POST'>
					...
					<a href="../facture/facture.php?id=<? echo $_GET['id']; ?>" target="_blank" class="login100-form-btn"><i class="fa fa-download" style="margin-right: 20px;"></i> Télécharger fiche d'inscription</a>
