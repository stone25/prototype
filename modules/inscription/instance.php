			...
			<div class="wrap-login100 p-t-85 p-b-20">
				...
				<form class="login100-form validate-form" action='../src/control/inscription/inscription.php' method='POST'>
					...
					<div class="wrap-input100 validate-input m-b-50" data-validate="Enter password">
						<select class="input100" name="instance">
						<?php
						$connexion = new Connexion();
							if($connexion->connecter())
							{
								$query = "SELECT * FROM instance WHERE iddiocese = $_SESSION[diocese] ORDER BY denomination ASC";
								...
								{
									$i++;
									echo'<option value="'.$instance['id'].'">'.$instance['denomination'].' '.$instance['localisation'].'</option>';
								}
							}
						?>
					...
					<div class="container-login100-form-btn">
						<button type="submit" name="select-instance" class="login100-form-btn">
							Suivant
						</button>
					</div>
				</form>
