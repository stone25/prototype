        ...
        <div class="dialog">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" action="../src/control/admin/utilisateur.php">
                        <div class="form-group">
                            <label>Matricule</label>
                            <input type="text" class="form-control span12" name="matricule">
                        </div>
                        <div class="form-group">
                        <label>Mot de passe</label>
                            <input type="password" class="form-controlspan12 form-control" name="password">
                        </div>
                        <input type="submit" class="btn btn-primary pull-right" name="btn-connexion" value="Connexion">
