...
if(isset($_POST['useradd']))
{
    ...
    $user->creerUser();
    echo "<META HTTP-EQUIV='Refresh' CONTENT= 1;URL='../../../blog/new_user.php'>";
...
if(isset($_POST['useredit']))
{
    ...
    $user->modifierUser();
    echo "<META HTTP-EQUIV='Refresh' CONTENT= 1;URL='../../../blog/list_user.php'>";
...
if(isset($_POST['authenticate']))
{
    ...
    if($user->authentifier())
    {
        ...
        echo "<META HTTP-EQUIV='Refresh' CONTENT= 1;URL='../../../blog/home.php'>";
    }
    else
    {
        echo "<META HTTP-EQUIV='Refresh' CONTENT= 1;URL='../../../blog/index.php?error=1'>";
    }
}
...
{
    unset($_SESSION['user']);
    echo "<META HTTP-EQUIV='Refresh' CONTENT= 1;URL='../../../blog/index.php'>";
}
