...
//Création
    public function creerCommande()
    {
        ...
        {
            $query = "INSERT INTO commande(numero, date_com, statut, id_user) VALUES ('$this->numero','$this->creation','$this->statut','$this->idjeciste')";
...
//Production
    public function produireCommande()
    {
        ...
        if($connexion->connecter())
        {
            $query = "UPDATE commande SET date_prod = '$this->production', statut = '$this->statut' WHERE id = $this->id";
            $result = mysqli_query($connexion->connexion, $query) or die(mysqli_error($connexion->connexion));
